...
class Chatroom extends React.Component {
  ...
  render() {
    let { name, chatroomId, handleChatWithFriend, avatar, lastMessage } = this.props
    ...
    if(lastMessage){
      //parse date
      let dateObj = new Date(lastMessage.date);
    ...
    let lastMessageContent = lastMessage && lastMessage.content
    if(lastMessage && (lastMessage.content.length > 70)) {
